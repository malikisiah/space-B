      ...
      <section className=" min-h-screen">
        <div className="max-w-screen-xl mx-auto px-4 py-16 gap-12 text-content md:px-8 xl:flex">
          <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
            ...
            <p className="max-w-xl mx-auto xl:mx-0 text-xl font-semibold  text-center pt-5">
              Embrace Your Rhythm, Unleash Your Grace
            </p>
            <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
              <Link
                href="/schedule"
                className="flex items-center justify-center gap-x-2 py-2 px-4 text-primary font-medium btn-accent rounded-lg md:inline-flex"
              >
                Current Schedule
                <svg
                  xmlns="http://www.w3.org/2000/svg"
